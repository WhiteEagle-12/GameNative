...
public class Container {
    ...
    public static final String APP_DATA_PATH = "/data/data/" + BuildConfig.APPLICATION_ID;
    public static final String IMAGEFS_FILES_PATH = APP_DATA_PATH + "/files/imagefs";
    public static final String STORAGE_PATH = APP_DATA_PATH + "/storage";
    public static final String[] MEDIACONV_ENV_VARS = {
            "MEDIACONV_AUDIO_DUMP_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/audio.dmp",
            "MEDIACONV_VIDEO_DUMP_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/video.dmp",
            "MEDIACONV_VIDEO_TRANSCODED_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/transcoded.mkv",
            "MEDIACONV_AUDIO_TRANSCODED_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/transcoded.wav",
            "MEDIACONV_BLANK_AUDIO_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/blank.wav",
            "MEDIACONV_BLANK_VIDEO_FILE=" + IMAGEFS_FILES_PATH + "/home/xuser/blank.mkv",
    };
    public static final String DEFAULT_DRIVES = "D:"+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"E:" + STORAGE_PATH;
